import { RecipeIngredientModel } from './model/recipe-ingredient.model';
...
export const MOCK_RECIPES: Recipe[] = [
  {
    ...
    ingredients: [
      {
        ingredient: {name: 'Dark rum (Appleton Estate Reserve)'} as IngredientModel,
        quantity: 2,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Fresh lime juice'} as IngredientModel,
        quantity: 1,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Simple sirup'} as IngredientModel,
        quantity: 1,
        unit: 'oz'
      }
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {name: 'Light or gold rum'} as IngredientModel,
        quantity: 1.5,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Coconut milk'} as IngredientModel,
        quantity: 2,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Fresh pineapple juice'} as IngredientModel,
        quantity: 2,
        unit: 'oz'
      }
    ] as RecipeIngredientModel[],
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {name: 'Mint leaves'} as IngredientModel,
        quantity: 6
      },
      {
        ingredient: {name: 'Simple syrup'} as IngredientModel,
        quantity: 0.75,
        unit: 'oz'
      },
      {
      ...
      {
        ingredient: {name: 'White rum'} as IngredientModel,
        quantity: 1.5,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Club soda'} as IngredientModel,
        quantity: 1.5,
        unit: 'oz'
      }
    ] as RecipeIngredientModel[],
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {name: 'Gin or vodka'} as IngredientModel,
        quantity: 2.5,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Dry vermouth'} as IngredientModel,
        quantity: 0.5,
        unit: 'oz'
      },
      {
        ingredient: {name: 'Olive brine'} as IngredientModel,
        quantity: 0.5,
        unit: 'oz'
      }
    ] as RecipeIngredientModel[],
